...
def print_min_max_cl_cd():
    ...
    print(f'min cl cl thickness model eval values: {min(cl_thickness_model_eval_cl_values)}')
    print(f'max cl cl thickness model eval values: {max(cl_thickness_model_eval_cl_values)}')
    print(f'min thickness cl thickness model eval values: {min(cl_thickness_model_max_thickness)}')
    print(f'max thickness cl thickness model eval values: {max(cl_thickness_model_max_thickness)}')
print_min_max_cl_cd()
