...
from vae import VAE
from latent_ddpm_conditional_1d import Diffusion
from modules import UNet_conditional
import aerosandbox as asb
from sklearn.manifold import TSNE

vae_path = "/home/reid/Projects/Airfoil_Diffusion/conditional_airfoil_diffusion/vae_epoch_200.pt"
diffusion_path = "/home/reid/Projects/Airfoil_Diffusion/conditional_airfoil_diffusion/models/conditional_latent_run_3/ckpt.pt"
...
conditioning_cl = torch.tensor([0.2]).to(device).unsqueeze(1)
...
diffusion = Diffusion(num_airfoil_points=latent_dim, device=device)
diffusion_model = UNet_conditional(c_in=1, c_out=1, cond_dim=1, time_dim=64, base_dim=8).to(device)
...
latent_vectors = diffusion.sample(diffusion_model, n_samples, None)
