...
def train(args):
    ...
    model = Unet1DConditional(16, cond_dim=1, dim_mults=(1, 2, 4), channels=2, dropout=0.).to(device)
    ...
    for epoch in range(args.epochs):
        ...
        for i, airfoil in enumerate(pbar):
            ...
            conditioning = max_thickness.float()
        ...
        if epoch % 100 == 0:
            ...
            sampled_images = diffusion.sample(batch_size=5, conditioning=max_thickness)
...
def launch():
    ...
    parser.add_argument('--run_name', type=str, default="lucid_thickness_standardized_run_1")
