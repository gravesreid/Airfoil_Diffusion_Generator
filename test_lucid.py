...
diffusion_path = "/home/reid/Projects/Airfoil_Diffusion/conditional_airfoil_diffusion/models/lucid_run_4/ckpt.pt"
...
diffusion_model = Unet1DConditional(32, cond_dim=1, channels=2).to(device)
...
generated_y = diffusion.sample(batch_size=n_samples, conditioning=conditioning_cl)
